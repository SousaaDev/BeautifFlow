...
exports.default = PublicCustomerLoginPage;
...
function PublicCustomerLoginPage() {
    var _this = this;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, public_1.publicApi.loginCustomer({
                            slug: slug,
                            email: data.email,
                ...
                case 3:
                    error_1 = _a.sent();
                    message = error_1 instanceof Error ? error_1.message : 'Erro ao entrar na conta';
    ...
    return (<div className="space-y-6 text-foreground max-w-md mx-auto">
      ...
      <div className="text-sm text-center text-muted-foreground">
        Ainda não tem conta?{' '}
        <button type="button" className="font-medium text-primary hover:underline" onClick={function () { return router.push("/agendar/".concat(slug, "/register")); }}>
